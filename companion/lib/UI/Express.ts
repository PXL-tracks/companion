...
export class UIExpress {
	...
	constructor(internalApiRouter: Express.Router) {
		...
		console.log('DEBUG: Checking paths for webui:')
		console.log('1. webui.zip:', getResourcePath('webui.zip'), 'exists?', fs.existsSync(getResourcePath('webui.zip')))
		console.log('2. static:', getResourcePath('static'), 'exists?', fs.existsSync(getResourcePath('static')))
		console.log('3. webui/build:', getResourcePath('webui/build'), 'exists?', fs.existsSync(getResourcePath('webui/build')))
		...
		console.log('DEBUG: Checking paths for docs:')
		console.log('1. docs.zip:', getResourcePath('docs.zip'), 'exists?', fs.existsSync(getResourcePath('docs.zip')))
		console.log('2. docs/build:', getResourcePath('docs/build'), 'exists?', fs.existsSync(getResourcePath('docs/build')))
