...
if [ ! -f "$MODULE_DIR/main.js" ]; then
    ...
    if ! git clone https://github.com/PXL-tracks/timeline-sequencer.git "$MODULE_DIR" 2>/dev/null; then
        echo ""
        echo ""
        echo -e "\033[35m  ____  _  __ _       __  __ ____ _____ ____  ____  \033[0m"
        echo -e "\033[35m |  _ \\\\ \\/ /| |     |  \\/  / ___|_   _|  _ \\/ ___| \033[0m"
        echo -e "\033[35m | |_) >  < | |     | |\\/| \\___ \\ | | | |_) \\___ \\ \033[0m"
        echo -e "\033[35m |  __/ /\\ \\| |___  | |  | |___) || | |  _ < ___) |\033[0m"
        echo -e "\033[35m |_| /_/  \\_\\_____| |_|  |_|____/ |_| |_| \\_\\____/ \033[0m"
        echo ""
